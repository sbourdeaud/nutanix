...
This Python script can be used to generate guest customization init scripts (*unattend.xml* for Windows and *cloud-init.yaml* for Linux) to be used when creating AHV VMs from templates or disk images.

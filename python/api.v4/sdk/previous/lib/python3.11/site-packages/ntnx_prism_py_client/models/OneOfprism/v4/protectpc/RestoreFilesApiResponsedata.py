...
class RestoreFilesApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.protectpc.RestoreFilesApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RestoreFilesApiResponsedata.discriminator_value_class_map.values():
            return list(RestoreFilesApiResponsedata.discriminator_value_class_map.keys())[list(RestoreFilesApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RestoreFilesApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RestoreFilesApiResponsedata):
            return False

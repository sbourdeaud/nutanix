...
class AccessKeyCredentials(object):
    ...
    :param access_key_id: (:attr:`access_key_id`) Access key Id for the object store provided for backup target.
    :type access_key_id: required
     min=16 chars, max=128 chars
    
    :param secret_access_key: (:attr:`secret_access_key`) Secret access key for the object store provided for backup target. 

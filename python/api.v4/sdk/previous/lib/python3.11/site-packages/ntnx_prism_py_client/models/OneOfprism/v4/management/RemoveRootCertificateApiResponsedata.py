...
class RemoveRootCertificateApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.RemoveRootCertificateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RemoveRootCertificateApiResponsedata.discriminator_value_class_map.values():
            return list(RemoveRootCertificateApiResponsedata.discriminator_value_class_map.keys())[list(RemoveRootCertificateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RemoveRootCertificateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoveRootCertificateApiResponsedata):
            return False

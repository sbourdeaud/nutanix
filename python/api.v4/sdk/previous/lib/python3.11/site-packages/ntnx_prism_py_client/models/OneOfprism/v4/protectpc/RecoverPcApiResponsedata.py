...
class RecoverPcApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'prism.v4.protectpc.PcRestoreRootTask': 'prism.v4.protectpc.PcRestoreRootTask',
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.protectpc.RecoverPcApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RecoverPcApiResponsedata.discriminator_value_class_map.values():
            return list(RecoverPcApiResponsedata.discriminator_value_class_map.keys())[list(RecoverPcApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RecoverPcApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecoverPcApiResponsedata):
            return False

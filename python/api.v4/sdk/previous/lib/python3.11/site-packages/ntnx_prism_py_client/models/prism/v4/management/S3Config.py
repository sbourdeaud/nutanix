...
class S3Config(object):
    ...
    :param bucket_name: (:attr:`bucket_name`) The bucket name of the object store endpoint where backup data of domain manager is to be stored. 
    :type bucket_name: required
     min=3 chars, max=63 chars
    
    :param region: (:attr:`region`) The region name of the object store endpoint where backup data of domain manager is stored.  (**Default** 'us-east-1')
    :type region: 
     max=63 chars

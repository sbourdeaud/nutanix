...
class ConfigureConnectionApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.ConfigureConnectionApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ConfigureConnectionApiResponsedata.discriminator_value_class_map.values():
            return list(ConfigureConnectionApiResponsedata.discriminator_value_class_map.keys())[list(ConfigureConnectionApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ConfigureConnectionApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConfigureConnectionApiResponsedata):
            return False

...
class AddRootCertificateApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.management.AddRootCertificateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in AddRootCertificateApiResponsedata.discriminator_value_class_map.values():
            return list(AddRootCertificateApiResponsedata.discriminator_value_class_map.keys())[list(AddRootCertificateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AddRootCertificateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AddRootCertificateApiResponsedata):
            return False

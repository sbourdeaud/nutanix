...
class RemoveReplicaResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.protectpc.RemoveReplicaResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RemoveReplicaResponsedata.discriminator_value_class_map.values():
            return list(RemoveReplicaResponsedata.discriminator_value_class_map.keys())[list(RemoveReplicaResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RemoveReplicaResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RemoveReplicaResponsedata):
            return False

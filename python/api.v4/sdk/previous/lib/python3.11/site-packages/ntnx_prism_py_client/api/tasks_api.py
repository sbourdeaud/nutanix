...
class TasksApi(object):
    ...
    def cancel_task(self, taskExtId, **kwargs):  # noqa: E501
        ...
        :param taskExtId: A globally unique identifier of a task. It consists of a prefix and a UUID separated by ':'. 'legacy' prefix can be used with a task UUID provided by previous API families.
        :type taskExtId:
            :class:`str`, required
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.0/config/tasks/{taskExtId}/$actions/cancel', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_task_by_id(self, extId, _select=None, **kwargs):  # noqa: E501
        ...
        :param extId: A globally unique identifier of a task. It consists of a prefix and a UUID separated by ':'. 'legacy' prefix can be used with a task UUID provided by previous API families.
        :type extId:
            :class:`str`, required
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.0/config/tasks/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_tasks(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.0/config/tasks', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,

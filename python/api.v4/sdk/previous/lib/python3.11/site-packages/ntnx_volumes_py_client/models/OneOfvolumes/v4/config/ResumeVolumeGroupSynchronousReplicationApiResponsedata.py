...
class ResumeVolumeGroupSynchronousReplicationApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfvolumes.v4.config.ResumeVolumeGroupSynchronousReplicationApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ResumeVolumeGroupSynchronousReplicationApiResponsedata.discriminator_value_class_map.values():
            return list(ResumeVolumeGroupSynchronousReplicationApiResponsedata.discriminator_value_class_map.keys())[list(ResumeVolumeGroupSynchronousReplicationApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ResumeVolumeGroupSynchronousReplicationApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResumeVolumeGroupSynchronousReplicationApiResponsedata):
            return False

...
class DeleteIgnoreWindowApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.DeleteIgnoreWindowApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeleteIgnoreWindowApiResponsedata.discriminator_value_class_map.values():
            return list(DeleteIgnoreWindowApiResponsedata.discriminator_value_class_map.keys())[list(DeleteIgnoreWindowApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeleteIgnoreWindowApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeleteIgnoreWindowApiResponsedata):
            return False

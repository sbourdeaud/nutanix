...
class UpdateIgnoreWindowApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.UpdateIgnoreWindowApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdateIgnoreWindowApiResponsedata.discriminator_value_class_map.values():
            return list(UpdateIgnoreWindowApiResponsedata.discriminator_value_class_map.keys())[list(UpdateIgnoreWindowApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdateIgnoreWindowApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateIgnoreWindowApiResponsedata):
            return False

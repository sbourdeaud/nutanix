...
class UpdatePolicyTaskApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.UpdatePolicyTaskApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in UpdatePolicyTaskApiResponsedata.discriminator_value_class_map.values():
            return list(UpdatePolicyTaskApiResponsedata.discriminator_value_class_map.keys())[list(UpdatePolicyTaskApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(UpdatePolicyTaskApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatePolicyTaskApiResponsedata):
            return False

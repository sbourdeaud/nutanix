...
class CreateIgnoreWindowApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'aiops.v4.config.IgnoreWindow': 'aiops.v4.config.IgnoreWindow',
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.CreateIgnoreWindowApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CreateIgnoreWindowApiResponsedata.discriminator_value_class_map.values():
            return list(CreateIgnoreWindowApiResponsedata.discriminator_value_class_map.keys())[list(CreateIgnoreWindowApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CreateIgnoreWindowApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateIgnoreWindowApiResponsedata):
            return False

...
from ntnx_aiops_py_client.models.aiops.v4.config.IgnoreWindow import IgnoreWindow  # noqa: F401,E501

class IgnoreWindowProjection(IgnoreWindow):
    ...
    def __init__(self, name=None, start_date_time=None, end_date_time=None, cluster_type=None, cluster_uuid=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        IgnoreWindow.__init__(self, name, start_date_time, end_date_time, cluster_type, cluster_uuid, ext_id, links, tenant_id, *args, **kwargs)
        self.discriminator = None

    def _initialize_object_type(self):
        return 'aiops.v4.config.IgnoreWindowProjection'
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(IgnoreWindowProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IgnoreWindowProjection):
            return False

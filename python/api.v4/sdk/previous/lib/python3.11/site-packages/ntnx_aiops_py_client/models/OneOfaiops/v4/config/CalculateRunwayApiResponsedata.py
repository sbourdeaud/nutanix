...
class CalculateRunwayApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfaiops.v4.config.CalculateRunwayApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CalculateRunwayApiResponsedata.discriminator_value_class_map.values():
            return list(CalculateRunwayApiResponsedata.discriminator_value_class_map.keys())[list(CalculateRunwayApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(CalculateRunwayApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CalculateRunwayApiResponsedata):
            return False

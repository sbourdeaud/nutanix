...
class UpgradesApi(object):
    ...
    def perform_upgrade(self, body, X_Cluster_Id=None, **kwargs):  # noqa: E501
        """Perform an LCM upgrade operation.

        >>> response = api.perform_upgrade(body, (optional) X_Cluster_Id)
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.0/operations/$actions/upgrade', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,

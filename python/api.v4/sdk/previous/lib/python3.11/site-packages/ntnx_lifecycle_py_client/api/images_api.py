        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/lifecycle/v4.0/resources/images', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,

...
class DeployArtifactsApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflifecycle.v4.operations.DeployArtifactsApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in DeployArtifactsApiResponsedata.discriminator_value_class_map.values():
            return list(DeployArtifactsApiResponsedata.discriminator_value_class_map.keys())[list(DeployArtifactsApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(DeployArtifactsApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeployArtifactsApiResponsedata):
            return False

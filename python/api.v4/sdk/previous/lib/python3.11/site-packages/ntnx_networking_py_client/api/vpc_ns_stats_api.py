        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.0/stats/vpc/{vpcExtId}/external-subnets/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,

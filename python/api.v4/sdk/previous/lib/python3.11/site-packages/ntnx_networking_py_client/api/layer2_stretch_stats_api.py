...
class Layer2StretchStatsApi(object):
    ...
    def get_layer2_stretch_stats(self, extId, _startTime, _endTime, _samplingInterval=None, _statType=None, _page=None, _limit=None, _select=None, **kwargs):  # noqa: E501
        ...
        :type _limit:
            :class:`int`
        :param _select: A URL query parameter that allows clients to request a specific set of properties for each entity or complex type. Expression specified with the $select must conform to the [OData V4.01](https://docs.oasis-open.org/odata/odata/v4.01/odata-v4.01-part1-protocol.html) URL conventions. If a $select expression consists of a single select item that is an asterisk (i.e., *), then all properties on the matching resource will be returned. - extId - links - rtt - statType - tenantId - throughputRxKbps - throughputTxKbps 
        :type _select:
            :class:`str`
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/networking/v4.0/stats/layer2-stretches/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,

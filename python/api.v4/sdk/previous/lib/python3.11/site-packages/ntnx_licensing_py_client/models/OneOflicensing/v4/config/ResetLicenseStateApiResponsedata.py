...
class ResetLicenseStateApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOflicensing.v4.config.ResetLicenseStateApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in ResetLicenseStateApiResponsedata.discriminator_value_class_map.values():
            return list(ResetLicenseStateApiResponsedata.discriminator_value_class_map.keys())[list(ResetLicenseStateApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(ResetLicenseStateApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResetLicenseStateApiResponsedata):
            return False

...
class VmDisk(object):
    ...
    def __init__(self, disk_ext_id=None, disk_size_bytes=None, storage_container=None, storage_config=None, data_source=None, is_migration_in_progress=None, *args, **kwargs):  # noqa: E501

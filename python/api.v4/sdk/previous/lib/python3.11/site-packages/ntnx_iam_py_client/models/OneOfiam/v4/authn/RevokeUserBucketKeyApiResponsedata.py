...
class RevokeUserBucketKeyApiResponsedata(object):
    ...
    discriminator_value_class_map = {
        ...
        'iam.v4.authn.UserBucketKeyRevokeResponse': 'iam.v4.authn.UserBucketKeyRevokeResponse',
    ...
    def _initialize_object_type(self):
        return 'OneOfiam.v4.authn.RevokeUserBucketKeyApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in RevokeUserBucketKeyApiResponsedata.discriminator_value_class_map.values():
            return list(RevokeUserBucketKeyApiResponsedata.discriminator_value_class_map.keys())[list(RevokeUserBucketKeyApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(RevokeUserBucketKeyApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RevokeUserBucketKeyApiResponsedata):
            return False

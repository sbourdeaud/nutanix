...
class DirectoryServicesApi(object):
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.0/authn/directory-services/{extId}/$actions/verify-connection-status', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def create_directory_service(self, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.0/authn/directory-services', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def delete_directory_service_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.0/authn/directory-services/{extId}', 'DELETE',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def get_directory_service_by_id(self, extId, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.0/authn/directory-services/{extId}', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def list_directory_services(self, _page=None, _limit=None, _filter=None, _orderby=None, _select=None, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.0/authn/directory-services', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def search_directory_service(self, extId, body, **kwargs):  # noqa: E501
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.0/authn/directory-services/{extId}/$actions/search', 'POST',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
    ...
    def update_directory_service_by_id(self, extId, body, **kwargs):  # noqa: E501
        ...
        :type extId:
            :class:`str`, required
        :param body: Updates a directory service based on the external identifier.
        :type body:
            :class:`~ntnx_iam_py_client.models.iam.v4.authn.DirectoryService`, required
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/iam/v4.0/authn/directory-services/{extId}', 'PUT',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,

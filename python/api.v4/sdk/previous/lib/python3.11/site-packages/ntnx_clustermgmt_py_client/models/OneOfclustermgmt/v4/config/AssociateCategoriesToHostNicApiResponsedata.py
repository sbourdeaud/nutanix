...
class AssociateCategoriesToHostNicApiResponsedata(object):
    ...
    def _initialize_object_type(self):
        return 'OneOfclustermgmt.v4.config.AssociateCategoriesToHostNicApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in AssociateCategoriesToHostNicApiResponsedata.discriminator_value_class_map.values():
            return list(AssociateCategoriesToHostNicApiResponsedata.discriminator_value_class_map.keys())[list(AssociateCategoriesToHostNicApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if sanitize:
                    ...
                    result[attr] = value
        if issubclass(AssociateCategoriesToHostNicApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssociateCategoriesToHostNicApiResponsedata):
            return False

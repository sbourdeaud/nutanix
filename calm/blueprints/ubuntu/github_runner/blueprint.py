...
# Secret Variables
BP_CRED_runner_KEY = read_local_file("BP_CRED_runner_KEY")
Profile_CentOS_Action_ScaleOut_variable_github_repo_token = read_local_file(
    "Profile_CentOS_Action_ScaleOut_variable_github_repo_token"
)
Profile_CentOS_Action_ScaleIn_variable_github_repo_token = read_local_file(
    "Profile_CentOS_Action_ScaleIn_variable_github_repo_token"
)
Profile_CentOS_variable_github_repo_token = read_local_file(
    "Profile_CentOS_variable_github_repo_token"
)
Profile_Ubuntu_variable_github_repo_token = read_local_file(
    "Profile_Ubuntu_variable_github_repo_token"
)

# Credentials
BP_CRED_runner = basic_cred(
    "runner",
    BP_CRED_runner_KEY,
    name="runner",
    type="KEY",
...
class LinuxGitHubRunner(Service):
    @action
    def __create__():

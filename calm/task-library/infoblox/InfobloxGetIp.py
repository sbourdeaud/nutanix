...
task_name:    InfobloxGetIp
description:  Given an Infoblox ip reference, retrieve details about the ip
              address.
input:        ip_ref (exp: "fixedaddress/ZG5zLmZpeGVkX2FkZHJlc3MkMTAuNDguMTA4LjE1MS4wLi4:10.48.108.151/default")
output:       vm_ip (ipv4 address)
"""
# endregion
...
if resp.ok:
    ...
    vm_ip = json.loads(resp.content)['ipv4addr']

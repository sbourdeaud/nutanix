...
# task_name:    PhpIPAMGetToken
# description:  Given a phpIPAM server ip/fqdn, app id and creds, return an auth token.
# outputvars:   phpipam_token (should be a secret variable)
"""
# endregion
...
if resp.ok:
    ...
    print "phpipam_token={}".format(json.dumps(phpipam_token))
else:
